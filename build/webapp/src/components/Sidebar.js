...
export default class Sidebar extends React.Component {
  ...
  getAQuietStreetGalleryIconName() {
    return this.props.isLoading ? 'ArtAuction-loading' : 'Art Auction'
  }
    ...
    return (
      <div className={`Sidebar ${this.getVisibilityClassName()}`}>
        <header>
          ...
          {visible && <h1 className="sidebar-title fadein">AQuietStreetGallery</h1>}
          <HelpButtonContainer />
        </header>
