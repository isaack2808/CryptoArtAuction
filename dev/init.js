...
import { env, Log } from 'archlinuxsolidityginachecli'
...
async function upsertRoadsProject() {
  ...
  if (!await Project.findByName('Genesis artauction')) {
    log.info('Inserting Genesis artauction project')

    await Project.insert({
      id: '55327350-d9f0-4cae-b0f3-8745a0431099',
      name: 'artauction',
      desc: 'A Quiet St Gallery Genesis artauction',
      link: '',
      public: false,
      parcels: 0,
      priority: 0,
      disabled: false,
      lookup: lookup['Genesis artauction']
    })
  }
